...
function maxIndexBy(array, key) {
  let [maxIndex, maxValue] = [0, key(array[0])];
...
const maxBy = (array, key) => array[maxIndexBy(array, key)]
...
module.exports = {
  ...
  intersect, mergeIntervals, groupBy, maxBy, maxIndexBy, addVec, subVec,
  manhattanDistance, BFS, DFS,
};
